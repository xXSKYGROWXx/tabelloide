...
export class TableComponent {
  ...
  editEmployee(id: number, employee: Employee) {
    this.employees.updateEmployee(id, employee).subscribe(
      _ => {
        alert("Dati impiegato aggiornati con successo!")
      },
      _ => {
        alert("Errore durante l'aggiornamento dei dati dell'impiegato")
      }
    )
  }
}